  ...
  return (
    <div className=''>
      <div className='flex  border-gray-800 border-t w-[1150px] ml-14 mt-10 '>
        <div className='mt-16 flex ml-[320px] items-center gap-2'>
          <h2 className='text-gray-600 font-medium text-xl'>ALL</h2>
        ...
        <div className='flex gap-16 ml-[280px] border mt-[100px] border-black w-[200px] h-10 '>
          ...
          {/* <div className='flex ml-4 mt-2'>
                    ...
                    <h2 className=''>Price:Low To High</h2>
                </div>
                <div><img src={dropdownimg} className='mt-4' /></div> */}
        </div>
      </div>
      <div className='flex'>
        <div>
          <div className='ml-[100px] text-xl font-medium'><h2>FILTERS</h2></div>
...
export default Wholecollection
